...
builder.Services.AddSwaggerGen(options => {
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        Version = "v1.0",
        Title = "Bulky Book V1",
        Description = "API to manage Book",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options => {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "CarHub_APIV1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "CarHub_APIV2");
    });
}
